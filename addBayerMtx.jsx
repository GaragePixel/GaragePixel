...
function addBayerMtxToPresetManager() {
    ...
    function drawBayerMtx2x2(doc,x,y) {
        ...
        plotPixel(doc,x+0,y+1,GREY(3*d));   plotPixel(doc,x+1,y+1,GREY(1*d));
    }
    ...
    function drawBayerMtx8x8(doc,x,y) {
        ...
        plotPixel(doc,x+0,y+0,GREY(Math.floor(0.0*d)));    plotPixel(doc,x+1,y+0,GREY(Math.floor(32.0*d))); plotPixel(doc,x+2,y+0,GREY(Math.floor(8.0*d)));    plotPixel(doc,x+3,y+0,GREY(Math.floor(40.0*d)));    plotPixel(doc,x+4,y+0,GREY(Math.floor(2.0*d)));plotPixel(doc,x+5,y+0,GREY(Math.floor(34.0*d)));plotPixel(doc,x+6,y+0,GREY(Math.floor(10.0*d)));   plotPixel(doc,x+7,y+0,GREY(Math.floor(42.0*d)));
